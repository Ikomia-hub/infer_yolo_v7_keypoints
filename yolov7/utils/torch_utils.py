...
def torch_load(weights, device):
    yolov7_folder = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    # add yolov7 folder to python path just to load the model then remove it
    if yolov7_folder not in sys.path:
